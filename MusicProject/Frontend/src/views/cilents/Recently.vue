  ...
  <div class="h-screen" style="background: #121212">
    <div class="flex" style="height: 88vh;">
      ...
      <div class="w-full h-full relative overflow-y-scroll">
        ...
        <div class="px-6 py-3">
          <div class=" pb-4">
            <h1 class="text-4xl font-semibold text-white tracking-wide hover:underline" style="padding-left: 0.5rem">Recently Added</h1>
            <h2 class="ml-2 text-sm tracking-wide hover:underline " style="color: #B3B3B3; padding-top: 0.5rem">Get Newest Recommendations For You!</h2>
          </div>
          <div class="pt-2 w-full flex flex-wrap">
            <div v-for="song in songs" :key="song.id" class="p-2 relative" style="width: 12rem; margin-right: 11px">
              ...
              <div class="w-full h-auto p-5 rounded-lg shadow-md" style="background: #282828">
                <img class="h-auto w-full shadow mb-2" style="object-fit: cover; width: 150px; height: 150px" :src="`${song.album.album_art}`" alt="cover_card">
